...
{
    public class SubInstruction : Instruction2OpsNode
    {
        ...
        public override InstructionGen EvalOperandsType()
        {
            ...
            return InstructionGen.Sub(newOperand1, newOperand2); // en fonction du type => différent type de mov
        }

        public override string ToString()
            => $"Node<Sub>[Op1: {this.operand1} Op2: {this.operand2}]";
    }
}
