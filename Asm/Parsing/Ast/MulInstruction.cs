...
{
    public class MulInstruction : Instruction2OpsNode
    {
        ...
        public override InstructionGen EvalOperandsType()
        {
            ...
            return InstructionGen.Mul(newOperand1, newOperand2); // en fonction du type => différent type de mov
        }

        public override string ToString()
            => $"Node<Mul>[Op1: {this.operand1} Op2: {this.operand2}]";
    }
}
